...
logger.add(MAIN_DIR / "general.log", rotation="500 MB", filter=not_error_filter, format=format_string)
logger.add(MAIN_DIR / "errors.log", rotation="500 MB", filter=error_filter, format=format_string)
